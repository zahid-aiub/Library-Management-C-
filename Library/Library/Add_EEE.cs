...
namespace Library
{
    ...
    public partial class Add_EEE : Form
    {
        ...
        private void saveBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    //                
                    cmd.CommandText = "insert into eee_book values('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "','" + textBox6.Text + "','" + img_path.ToString() + "')";
                    cmd.ExecuteNonQuery();

                    MessageBox.Show("EEE book added successfully...!!!");
                    textBox1.Clear();
                    textBox2.Clear();
                    textBox3.Clear();
                    textBox4.Clear();
